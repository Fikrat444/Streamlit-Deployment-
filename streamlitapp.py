...
if menu=='Homepage':
    ...
    def describeStat(df):
        ...
        c_eda1,c_eda2,c_eda3=st.beta_columns([2.5,1.5,2.5]) # approximately 38.5% 23% 38.5%
    ...
    if not os.path.exists("formodel.csv"):
        ...
        c_model1_1,c_model2_1=st.beta_columns(2)
    ...
    # Modeling Part
            ...
            report = classification_report(y_test, y_pred, output_dict=True) # creating dataframe from classifaction report
